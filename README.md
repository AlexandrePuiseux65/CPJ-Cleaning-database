...
This project was born out of a gap identified during the module **"Information Visualisation - CS5044"**. The CPJ database was provided without a cleaning phase, so I built one with three goals:
